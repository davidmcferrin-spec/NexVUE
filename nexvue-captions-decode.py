...
class Cea608Cc1:
    ...
    def reset(self) -> None:
        """Fully clear displayed and non-displayed memory, cursor, mode, and
        the last-emitted text. Called at construction. A full reset, not just
        erase-displayed-memory (EDM), so pop-on leftovers cannot resurface."""

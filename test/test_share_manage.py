...
class TestShareManage(unittest.TestCase):
    ...
    def test_auth_api_actions(self) -> None:
        api = (ROOT / "web-node" / "nexvue-auth.php").read_text(encoding="utf-8")
    ...
    def test_auth_lib_stores_share_token(self) -> None:
        lib = (ROOT / "web-node" / "nexvue-auth-lib.php").read_text(encoding="utf-8")
        self.assertIn("NEXVUE_AUTH_SCHEMA_VERSION = 4", lib)
    ...
    def test_users_ui_edit_delete(self) -> None:
        html = (ROOT / "web-node" / "users.html").read_text(encoding="utf-8")
    ...
    def test_share_viewer_sees_time_left(self) -> None:
        js = (ROOT / "web-node" / "nexvue-auth-gate.js").read_text(encoding="utf-8")
